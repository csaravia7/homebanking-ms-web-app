...
[[ "$DELETE_OPERATOR" == "true" ]] && echo "  OTel Operator:        ELIMINADO" || echo "  OTel Operator:        conservado"
echo "  Load Generator:       eliminado (replicas=0 por default — reactivar con:"
echo "    kubectl scale deployment/load-generator -n homebanking --replicas=1)"
