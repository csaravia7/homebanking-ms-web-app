package com.homebanking.transaction.exception;
 ...
 * (e.g. malformed request bodies, validation failures, unexpected runtime errors).
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleValidationError(MethodArgumentNotValidException e, WebRequest request) {
        logger.warn("Validation failed on {}: {}", request.getDescription(false), e.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
